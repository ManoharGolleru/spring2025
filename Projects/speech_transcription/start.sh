...
gnome-terminal --tab --title "NODE.JS" --working-directory=${PWD}/html -- bash -ic "export HISTFILE=${HOME}/.bash_history_junk1; $SCRIPT1; history -s $SCRIPT1; exec bash" 

# Start WhisperLive Server
SCRIPT2="python3 run_server.py --port 9091 --backend faster_whisper"
gnome-terminal --tab --title "FASTER_WHISPER" --working-directory=${PWD}/scripts -- bash -ic "export HISTFILE=${HOME}/.bash_history_junk2; $SCRIPT2; history -s $SCRIPT2; exec bash" 

# Start our main.py node:
SCRIPT3="python3 main.py"
gnome-terminal --tab --title "MAIN.PY" --working-directory=${PWD}/scripts -- bash -ic "export HISTFILE=${HOME}/.bash_history_junk3; $SCRIPT3; history -s $SCRIPT3; exec bash" 
...
chromium "https://localhost:8080/index.html"
chromium "https://localhost:8080/admin.html"
